...
public class CssTemplateController {
    ...
    public ResponseEntity<List<ColorStyle>> getAllCssOptions() {
        List<ColorStyle> options = colorStyleService.getAllColorStyles();
    ...
    public ResponseEntity<Set<String>> getCategories() {
        // Temporary implementation - categories not supported in simplified service
        Set<String> categories = Set.of("background", "text", "button", "other");
    ...
    public ResponseEntity<List<ColorStyle>> getOptionsByCategory(
        ...
        // Simplified - return all styles for now
        List<ColorStyle> options = colorStyleService.getAllColorStyles();
        return ResponseEntity.ok(options);
    }
    ...
    public ResponseEntity<Map<String, List<ColorStyle>>> getOptionsGroupedByCategory() {
        // Simplified - return ungrouped for now
        List<ColorStyle> allOptions = colorStyleService.getAllColorStyles();
        Map<String, List<ColorStyle>> groupedOptions = Map.of("all", allOptions);
    ...
    public ResponseEntity<ColorStyle> getCssOptionById(
        ...
        ColorStyle option = colorStyleService.getColorStyleById(colorTypeId);
    ...
    public ResponseEntity<String> initializeCssOptions() {
        try {
            // Initialization removed from simplified service
