...
abstract class DesignComponentControllerTestSupport {
  ...
  private TypeCode typeCodeFor(String suffix) {
    return switch (suffix) {
      case "comp-a" -> TypeCode.MAINVIEW_STYLE_PRIMARY_BACKGROUND_IMAGE;
      case "comp-b" -> TypeCode.DEFAULT_PROFILE_STYLE_PROFILE_IMAGE;
      default -> TypeCode.BUTTON_STYLE_ADD_FRIEND_IMAGE;
    };
  }
}
