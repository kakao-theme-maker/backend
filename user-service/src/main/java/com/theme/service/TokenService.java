...
import com.theme.redis.RedisSingleDataService;
...
public class TokenService {
    ...
    public boolean saveAccessToken(String email, String accessToken) {
        return redisSingleDataService.set(getAccessTokenKey(email), accessToken, AuthProperty.ACCESS_TOKEN_EXPIRES_IN.intValue());
    }

    public boolean saveRefreshToken(String email, String refreshToken) {
        return redisSingleDataService.set(getRefreshTokenKey(email), refreshToken, AuthProperty.REFRESH_TOKEN_EXPIRES_IN.intValue());
    }
